...
var myLatLng = { lat: 31.798257, lng: -85.954404 };
var mapOptions = {
    center: myLatLng,
    zoom: 15,
...
function calcRoute() {
    ...
    directionsService.route(request, function (result, status) {
        if (status == google.maps.DirectionsStatus.OK) {
            ...
            //show error message
            output.innerHTML = "<div class='alert-danger'><i class='fas fa-exclamation-triangle'></i> Couldn't Find Transportation For Your Distnation.</div>";
        }
    });
